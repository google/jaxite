...
def brot_cm(
  ...
  pre-encoded rotated plaintexts.
  ...
  Args:
    ...
    pt_rot_mu_all: A list of Plaintexts containing the encoded rotated versions
      of the message mu. Length must be equal to num_slots.
  ...
  # Accumulate the products along the batch axis (0) in uint64 to prevent overflow
