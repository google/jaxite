...
tpu_test(
    ...
    deps = [
        ":jaxite",
        "//perftools/accelerators/xprof/api/python:xprof_analysis_client",  # buildcleaner: keep
        "//perftools/accelerators/xprof/api/python:xprof_session",  # buildcleaner: keep
